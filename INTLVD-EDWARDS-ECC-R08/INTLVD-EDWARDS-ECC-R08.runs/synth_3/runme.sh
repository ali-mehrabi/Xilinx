...
HD_PWD='D:/XILINX_PROJECTS/INTLVD-EDWARDS-ECC-R08/INTLVD-EDWARDS-ECC-R08.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log EDECC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EDECC.tcl
