...
HD_PWD='D:/XILINX_PROJECTS/TIMING-MADD-REV02/TIMING-MADD-REV02.runs/synth_12'
cd "$HD_PWD"
...
EAStep vivado -log INTLVD_RED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source INTLVD_RED.tcl
